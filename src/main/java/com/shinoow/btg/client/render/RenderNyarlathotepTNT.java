...
public class RenderNyarlathotepTNT extends Render<EntityNyarlathotepTNT> {
	...
	public RenderNyarlathotepTNT(RenderManager renderManagerIn)
	{
	 ...
	 */
	@Override
	public void doRender(EntityNyarlathotepTNT entity, double x, double y, double z, float entityYaw, float partialTicks)
	{
	 ...
	 */
	@Override
	protected ResourceLocation getEntityTexture(EntityNyarlathotepTNT entity)
	{
